<nav class="bg-wlp px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50 lg:z-0">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            {{-- <a href="/" class="flex items-center justify-between mr-4">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SPK PROFILE MATCHING</span>
                    </a> --}}
        </div>
